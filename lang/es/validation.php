...
return [
    ...
    */
    ...
    'date_format'          => 'La fecha no es válida.', /*'El campo :attribute no corresponde con el formato de fecha :format.',*/
    'different'            => 'Los campos :attribute y :other deben ser diferentes.',
    'digits'               => 'El campo :attribute debe ser un número de :digits dígitos.',
    'digits_between'       => 'El campo :attribute debe contener entre :min y :max dígitos.',
    'dimensions'           => 'El campo :attribute tiene dimensiones de imagen inválidas.',
    'distinct'             => 'El campo :attribute tiene un valor duplicado.',
    'email'                => 'El email no es válido.', /*'El campo :attribute debe ser una dirección de correo válida.',*/
    ...
    'required'             => 'Campo requerido.', /*'El campo :attribute es obligatorio.',*/
    'required_if'          => 'Campo requerido.', /*'El campo :attribute es obligatorio cuando el campo :other es :value.',*/
    ...
    */
    ...
    'attributes' => [
        ...
        'area'                => 'área de la organización',
        'direccion_ins'       => 'dirección',
        'telefonos'           => 'teléfonos',
        'telefono'            => 'teléfono',                       
        'otros1'              => 'otros',                       
        'otros2'              => 'otros',
        ...
        'ubicacion'           => 'ubicación',
        'duracion'            => 'duración',
        'nro_operacion'       => 'número de operación bancaria',
        'nombre_titulo'       => 'nombre de la certificación',
        'code'                => 'código',
        ...
        'tiempo_validez'      => 'tiempo de vigencia del certificado',
        'tipo_documento'      => 'tipo de documento',        
        'tipo_contrato'       => 'tipo de contrato',
        'titulo_nombre.*'     => 'título y nombre',
        'cargo_docente.*'     => 'cargo docente',
        'code_profesional.*'  => 'código profesional',
        'otro_code.*'         => 'otro',
        'precio_oferta'       => 'precio de oferta',
        'pais_residencia'     => 'país de residencia',
        'tipo_soporte'        => 'tipo de soporte',
        'tipo_persona'        => 'tipo de persona',
        'tipo_documento_sp'   => 'tipo de documento',
        'nro_documento_sp'    => 'número de documento',
        'nombre_apellidos'    => 'nombre y apellidos',
        'nro_orden'           => 'número de orden',
        'observacion'         => 'observación',
        'observacion_old'     => 'observación',
